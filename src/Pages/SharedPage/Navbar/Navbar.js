...
const Navbar = () => {
  ...
  const handleLogOut = (e)=>{
    ...
    return (
        <div className="navbar bg-[#EEFBFA]">
  <div className="navbar-start">
    ...
    <Link to="/" className="btn btn-ghost normal-case text-xl"><img src={Logo} alt="Dentist New Work" className="w-12 h-12 rounded-full" /></Link>
  </div>
